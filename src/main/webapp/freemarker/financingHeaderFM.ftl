...
<div id="search">
	  <p><span>融资类型：</span>
	  <#list ctypeEightList as ctypeEight>
      	<a href="javascript:void(0);" value="${ctypeEight.did?c}">${ctypeEight.dname}</a>
      </#list>
      ...
      <a href="javascript:void(0);" class="all now">全部</a></p>
      <p><span>融资金额：</span>
	  <#list ctypeNightList as ctypeNight>
      	<a href="javascript:void(0);" value="${ctypeNight.brange?c}-${ctypeNight.erange?c}">${ctypeNight.dname}</a>
      </#list>
      <a href="javascript:void(0);" class="all now">全部</a></p>
      <p><span>注册资本：</span>
