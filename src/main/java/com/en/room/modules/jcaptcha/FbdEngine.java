package com.en.room.modules.jcaptcha;
 ...
 */
public class FbdEngine extends ListImageCaptchaEngine {
    ...
    protected void buildInitialFactories() {
        ...
        TextPaster randomPaster = new DecoratedRandomTextPaster(minWordLength,
                maxWordLength, colors, new TextDecorator[]{/*new LineTextDecorator(new Integer(1),
                lineColors)*/});
        ...
        FontGenerator font = new RandomFontGenerator(fontSize, fontSize,
                new Font[]{new Font("nyala", Font.BOLD, fontSize),
                        ...
                        new Font("Credit valley", Font.BOLD, fontSize),new Font("Arial", Font.BOLD, fontSize),
                        new Font("Tahoma", Font.BOLD, fontSize), new Font("Verdana", Font.BOLD, fontSize),
                        new Font("Helvetica", Font.BOLD, 15), new Font("宋体", Font.BOLD, fontSize),
                        new Font("黑体", Font.BOLD, fontSize), new Font("幼圆", Font.BOLD, fontSize)});
