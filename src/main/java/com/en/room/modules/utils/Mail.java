...
public class Mail {  
    ...
    public void setAddress(String strAddress, int iAddressType) {  
        switch (iAddressType) {  
        case Mail.TO: {  
            String[] alAddress = strAddress.split(";");//StringHelper.split(strAddress, ";");  
    ...
    public static void main(String[] args) {
    	 Mail mail = new Mail();  
         mail.setAddress("tony_mi@163.com;", Mail.TO);  
                 // 设置发送邮箱  
         String username = "874958364@qq.com";
         mail.setFromAddress(username);  
         mail.setSMTPHost("smtp.qq.com",username, "liumi1992");  
